...
- 當 b == 0 時，表示 已經沒有新的進位了，加法完全結束了，剩下的 a 就是最後答案。
```python
while b != 0:
```
...
## 🧪 範例演算 (a = 5 (0101)、b = 3 (0011))
### 第 1 輪：
```ini
sum_no_carry = a ^ b = 0101 ^ 0011 = 0110 (6)
